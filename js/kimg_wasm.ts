...
interface GeneratedBindingsModule {
    ...
    default(module_or_path?: { module_or_path: InitInput | Promise<InitInput> } | InitInput | Promise<InitInput>): Promise<InitOutput>;
}
...
const COMPOSITION_PROXY_HANDLER: ProxyHandler<Composition> = {
    get(target, prop, receiver) {
        ...
        const value = (target as Composition & { _inner: RawCompositionMethods })._inner[prop as keyof RawCompositionMethods];
        return typeof value === "function" ? value.bind((target as Composition & { _inner: RawCompositionMethods })._inner) : value;
    },
...
function normalizeSyncInitInput(module: { module: SyncInitInput } | SyncInitInput): { module: SyncInitInput } {
